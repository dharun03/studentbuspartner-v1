...
function Sidebar() {
  const sidebarClass =
    "flex items-center gap-2 border-transparent px-4 py-3 text-gray-400 transition-all duration-200 hover:border-s-[3px] hover:border-white  hover:bg-zinc-700 hover:text-white hover:rounded-md";

  return (
    <aside>
      <div className="fixed flex h-full flex-col justify-between border-e bg-zinc-800">
        <div className="px-4 py-6">
          {/* <span className="grid h-10 w-32 place-content-center rounded-lg bg-gray-100 text-xs text-gray-600">
        </span> */}
          <ul>
            <li>
              <NavLink to="/dashboard" className={sidebarClass}>
                <svg
            ...
            <li>
              <NavLink to="/manageStudents" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="16"
                  width="20"
            ...
            <li>
              <NavLink to="/manageBuses" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="16"
                  width="18"
            ...
            <li>
              <NavLink to="/manageDrivers" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="16"
                  width="18"
            ...
            <li>
              <NavLink to="/manageRoutes" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="16"
                  width="16"
            ...
            <li>
              <NavLink to="/studentComplaints" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <NavLink to="/driverComplaints" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                ...
                <span className="text-sm font-medium"> Driver Queries </span>
              </NavLink>
              <NavLink to="/notifications" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <NavLink to="/driverNotifications" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                ...
                <span className="text-sm font-medium">Driver Notification</span>
              </NavLink>
              <NavLink to="/attendence" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="size-4 opacity-60"
                ...
                <span className="text-sm font-medium">Bus Attendence</span>
              </NavLink>
              <NavLink to="/stopattendence" className={sidebarClass}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="size-4 opacity-60"
                ...
                <span className="text-sm font-medium">Stop Attendence</span>
              </NavLink>
            </li>
          </ul>
        </div>
        ...
        <div className="mb-2 flex items-center gap-1">
          ...
          <p className="drop-shadow-[0_35px_35px_rgba(255, 255, 255, 0.907)] mr-2 font-inter text-[15px] font-bold text-gray-300">
            Student Bus Partner
          </p>
        </div>
        ...
        {/* <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
          <a
            href="#"
            className="flex items-center gap-2 bg-zinc-800 p-4 text-gray-400  transition-all duration-200 hover:rounded-md hover:border-s-[3px]  hover:border-white hover:bg-zinc-700 hover:text-white"
          >
